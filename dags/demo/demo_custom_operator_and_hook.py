...
try:
    from operators import MyBasicMathOperator
    from hooks import CatFactHook
except ImportError:
    from plugins.operators import MyBasicMathOperator
    from plugins.hooks import CatFactHook
...
def my_math_cat_dag():
    ...
    multiply = MyBasicMathOperator(
        task_id="multiply",
        # use the return value from the add task as the first_number,
        # pulling from XCom
    ...
    def use_cat_fact_hook(number):
        ...
        # instantiating a CatFactHook at runtime of this task
